...
import { AbstractContract, bsv, Artifact, PubKeyHash, VerifyResult, CallData, AsmVarValues } from "scryptlib";
...
import { MethodsMetaValue } from "./decorators";
...
export type OffchainUpdates<T extends SmartContract> = {
    [methodName: string]: (instance: T, ...args: any[]) => any;
};
/**
 * @ignore
...
export declare class SmartContract {
     ...
     */
    offchainUpdates?: OffchainUpdates<this>;
    /** @ignore */
    _csNum: number;
    /** @ignore */
    _ctx?: ScriptContext;
    ...
    /** @ignore */
    protected getDelegateClazz(): typeof AbstractContract;
    /** @ignore */
    protected static getDelegateClazz(): typeof AbstractContract | undefined;
    protected getDelegateInstance(): AbstractContract;
    protected setDelegateInstance(delegateInstance: AbstractContract): void;
   ...
   */
    ...
    getTxBuilder<T extends this>(methodName: string): MethodCallTxBuilder<T>;
    protected getDefaultTxBuilder<T extends this>(methodName: string): MethodCallTxBuilder<T>;
    /**
    ...
    /** @ignore */
    protected getMethodsMeta(methodName: string): MethodsMetaValue;
    /** @ignore */
    private diffOutputs;
    /**
