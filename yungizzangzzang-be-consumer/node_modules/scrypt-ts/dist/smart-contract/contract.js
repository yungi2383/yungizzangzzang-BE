...
class SmartContract {
    ...
    /** @ignore */
    static getDelegateClazz() {
        return this.DelegateClazz;
    }
    getDelegateInstance() {
        return this.delegateInstance;
    }
    setDelegateInstance(delegateInstance) {
     ...
     */
    get scriptSize() {
        return this.lockingScript.toBuffer().length;
    }
    /**
   ...
   */
    ...
    callDelegatedMethod(methodName, ...args) {
        ...
        autoFillParams.forEach((param, idx) => {
            ...
            if (param.name.startsWith("__scrypt_ts_accessPathForProp__") && param.type === "bytes") {
                ...
                autoFillArgBindings.set(param.name, (0, crypto_1.randomBytes)(2 /* bytes per access */ * 30 /* estimated accesses */).toString('hex'));
            }
    ...
    getTxBuilder(methodName) {
        ...
        return this.getDefaultTxBuilder(methodName);
    }
    getDefaultTxBuilder(methodName) {
    ...
    */
    ...
    static autoPayfee(tx, feePerKb, signer, address, additional = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            tx['_feePerKb'] = feePerKb;
            if (tx.outputs.length > 0 && (0, utils_2.checkTxFee)(tx, feePerKb)) {
                return;
            }
            // todo fix bsv type
